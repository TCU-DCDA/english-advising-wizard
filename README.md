...
- **Updating Offerings for a New Semester:** From `course-scraper/`, run `node scrape.mjs -t "Fall 2026" -s ENGL,CRWT,WRIT -l 49999 -o ../english-advising-wizard/src/data/offerings-fa26.json`. Then update the import in `src/services/courses.ts` to point to the new file.
