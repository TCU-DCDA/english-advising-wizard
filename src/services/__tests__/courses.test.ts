...
describe('checkPrerequisites', () => {
  ...
  it('auto-satisfies ENGL 10803 when ENGL 20803 is completed', () => {
    // ENGL 30133 requires ENGL 10803 AND ENGL 20803 AND @any-lower-div
    // Providing only 20803 should imply 10803 (and 20803 satisfies @any-lower-div)
    const result = checkPrerequisites('ENGL 30133', ['ENGL 20803'], [])
    expect(result.met).toBe(true)
    expect(result.unmetGroups).toEqual([])
  })
